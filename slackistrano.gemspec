...
Gem::Specification.new do |gem|
  ...
  gem.email = %w[philip@pjkh.com]
  gem.description = 'Send notifications to Slack about Capistrano deployments.'
  gem.summary = 'Send notifications to Slack about Capistrano deployments.'
